            ...
            <div className="rounded-2xl xl:col-span-9 w-full border border-gray-200 bg-white dark:border-gray-800 dark:bg-white/[0.03]">
                ...
                >
                    <div className="divide-y divide-gray-200 dark:divide-gray-800">
                        <RowItem title="Material UI" time="12:16 pm" />
                        <RowItem title="Wise" time="12:16pm" />
                        <RowItem title="Paypal" time="May, 24" />
                        <RowItem title="Google Meet" time="May, 27" />
                        <RowItem title="Loom" time="11:20" />
                        <RowItem title="Airbnb" time="11:45" />
                        <RowItem title="Facebook" time="Apr, 9" />
                        <RowItem title="Instagram" time="Jun, 12" />
                    </div>
                </div>
