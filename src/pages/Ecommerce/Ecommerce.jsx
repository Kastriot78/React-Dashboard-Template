...
import CustomersDemographic from './CustomersDemographic';
    ...
    return (
        <div>
            <Row gutter={[16, 16]} className="h-full">
                ...
                <Col xs={24} md={12}>
                    <div className="rounded-2xl border border-gray-200 dark:border-gray-800 dark:bg-white/[0.03] h-full">
                        <div className="px-5 pt-5 bg-white shadow-default rounded-2xl pb-11 dark:bg-gray-900 sm:px-6 sm:pt-6">
                            <div className="flex justify-between">
                                ...
                                <div className="relative inline-block">
                                    <button className="dropdown-toggle cursor-pointer" onClick={handleToggleDropdown}>
                                        <svg
                                            width="1em"
                                            height="1em"
                                            viewBox="0 0 24 24"
                                    ...
                                    {toggleDropdown && (
                                        <div className="absolute z-40  right-0 mt-2  rounded-xl border border-gray-200 bg-white  shadow-theme-lg dark:border-gray-800 dark:bg-gray-dark w-40 p-2" ref={dropdownRef}>
                                            <button className="px-4 py-2 text-sm flex w-full font-normal text-left text-gray-500 rounded-lg hover:bg-gray-100 hover:text-gray-700 dark:text-gray-400 dark:hover:bg-white/5 dark:hover:text-gray-300">
                                                View More
                                            </button>
                                            <button className="px-4 py-2 text-sm flex w-full font-normal text-left text-gray-500 rounded-lg hover:bg-gray-100 hover:text-gray-700 dark:text-gray-400 dark:hover:bg-white/5 dark:hover:text-gray-300">
                                                Delete
